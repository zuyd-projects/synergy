...
A simple tool for drawing polygons on a map and retrieving the coordinates of each vertex in the format POINT(x y). These coordinates can be copied and used in GIS software or databases.
